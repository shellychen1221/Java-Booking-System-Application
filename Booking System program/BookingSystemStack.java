...
public class BookingSystemStack {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookingSystemStack window = new BookingSystemStack();
	...
	private void initialize() {
		frmMenu = new JFrame();
		frmMenu.setTitle("Menu_Stack");
		frmMenu.getContentPane().setBackground(UIManager.getColor("menu"));
		frmMenu.setBounds(100, 100, 565, 721);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BookingSystemStack2 s1 = new BookingSystemStack2();
				s1.Screen_2();
			}
		});
		...
		lblRoom1_1.setIcon(new ImageIcon("C:\\Users\\shell\\Desktop\\456.png"));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BookingSystemStack3 s2 = new BookingSystemStack3();
				s2.Screen_3();
			}
		});
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\shell\\Desktop\\booking-hotel-online-cartoon-icon-illustration-business-technology-icon-concept_138676-2126.jpg"));
		...
		lblRoom1.setIcon(new ImageIcon("C:\\Users\\shell\\Desktop\\jp.jpg"));
		...
		frmMenu.getContentPane().add(btnCancel);
		...
		lblRoom2.setIcon(new ImageIcon("C:\\Users\\shell\\Desktop\\unnamed.jpg"));
		lblRoom2.setFont(new Font("Yu Gothic UI", Font.PLAIN, 16));
		lblRoom2.setBounds(273, 190, 230, 158);
		...
		lblNewLabel_2_1.setBounds(30, 337, 267, 37);
		...
		lblNewLabel_2_1_1.setBounds(270, 337, 267, 37);
		...
		lblNewLabel_2_3.setBounds(30, 358, 379, 37);
