...
public class BookingSystemStack2 {
	...
	public static Stack<String> phonestack=new Stack<>();
	public static Stack<String> datestack=new Stack<>();
	public static Stack<String> daystack=new Stack<>();
	public static Stack<String> roomstack=new Stack<>();
	public static Stack<String> choicestack=new Stack<>();
	...
	public static void Screen_2() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookingSystemStack2 window = new BookingSystemStack2();
	...
	private void initialize() {
		...
		frmBooking.setTitle("Booking_Stack");
		...
		lblTelephone.setBounds(83, 209, 87, 37);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lbldoubleJLabel.setBounds(150, 345, 100, 37);
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\shell\\Desktop\\1.png"));
		...
		lblCardOrCash.setBounds(82, 458, 113, 37);
		...
		btnCash.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lblcashJLabel.setBounds(83, 512, 86, 23);
		...
		btnCash.setBounds(176, 512, 90, 23);
		...
		btnConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("Stack push "+time+" nanotime");
				...
				if (name.contains(" ")) {
					...
					try {
						File file = new File(
								"C:\\Users\\shell\\eclipse-workspace\\finalproject\\src\\finalproject\\users\\"
										+ username + ".txt");
						if (file.exists() && !file.isDirectory()) {
							...
							bw.write(namestack.pop() + System.lineSeparator());
							bw.write(phonestack.pop() + System.lineSeparator());
							bw.write(datestack.pop() + System.lineSeparator());
							bw.write(daystack.pop() + System.lineSeparator());
							bw.write(roomstack.pop() + System.lineSeparator());
							bw.write(choicestack.pop() + System.lineSeparator());
							long time1=System.nanoTime()-start1;
							System.out.println("Stack pop "+time1+" nanotime");
							System.out.println("Stack total: "+(time+time1));
							bw.close();
							newfileFile.close();
						}
